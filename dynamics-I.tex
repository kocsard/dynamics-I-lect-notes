...
\include{first-examples.tex}

\include{fundamental-thm-ds.tex}

\include{real-line.tex}

\include{circle-maps.tex}
...
There are three results that are fundamental in the local hyperbolic theory of non-linear dynamics, which are the following: the continuation of hyperbolic periodic points
